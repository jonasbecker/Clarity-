...
| 13 ✅ | Operatoren-Erkennung (Anforderungsbereiche I–III: nennen/berechnen/beurteilen …) für die Schwierigkeit; Aufgabentyp-Kategorien (Multiple Choice, Rechenaufgabe, Anwendungsaufgabe, Wissensfrage, Diskussion) als Tag — automatisch per KI/Datei ODER manuell per Chip im Formular wählbar; kategorie-basierte Lernschätzung (Dauer aus deinen bisherigen Ist-Zeiten je Kategorie); KI-Vorschlag als Karte vor der Übernahme |
| 14 ✅ | Datei-Analyse erkennt zusätzlich das **Fach** (ordnet einem vorhandenen Kurs zu) und die **Veranstaltungsart** (Vorlesung/Übung/Seminar/Praktikum/Tutorium, als Tag → filterbar); lernende Dauer nutzt die Veranstaltungsart-Historie (bevorzugt gleiches Fach), sonst die Kategorie; Veranstaltungsart auch manuell per Chip wählbar |
